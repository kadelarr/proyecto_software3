...
angular.module('ticketmonster', [ 'ngRoute', 'ngResource' ]).config(
		[ '$routeProvider', function($routeProvider) {
			$routeProvider.when('/', {
				...
				templateUrl : 'views/Event/search.html',
				...
				controller : 'NewEventCategoryController'
				...
				controller : 'NewMediaItemController'
				...
				templateUrl : 'views/Section/search.html',
			...
			}).when('/SectionAllocations', {
				templateUrl : 'views/SectionAllocation/search.html',
				controller : 'SearchSectionAllocationController'
			}).when('/SectionAllocations/new', {
				templateUrl : 'views/SectionAllocation/detail.html',
				controller : 'NewSectionAllocationController'
			}).when('/SectionAllocations/edit/:SectionAllocationId', {
				templateUrl : 'views/SectionAllocation/detail.html',
				controller : 'EditSectionAllocationController'
			}).when('/Shows', {
				templateUrl : 'views/Show/search.html',
				controller : 'SearchShowController'
			}).when('/Shows/new', {
				templateUrl : 'views/Show/detail.html',
				controller : 'NewShowController'
			}).when('/Shows/edit/:ShowId', {
				templateUrl : 'views/Show/detail.html',
				controller : 'EditShowController'
			}).when('/Tickets', {
				templateUrl : 'views/Ticket/search.html',
				...
				controller : 'NewTicketCategoryController'
				...
				controller : 'NewTicketPriceController'
